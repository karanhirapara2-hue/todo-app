...
function AppLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-[#edeae4] flex">
      ...
      {/* Sidebar */}
      <div
        className={`hidden md:block md:w-64 md:bg-[#f4ede4] md:shadow-xl md:fixed md:left-0 md:top-0 md:h-full md:z-40 md:p-8 md:rounded-r-2xl ${
          isOpen ? 'fixed inset-y-0 left-0 w-64 bg-[#f4ede4] shadow-xl z-40 p-8 rounded-r-2xl' : ''
        }`}
      >
